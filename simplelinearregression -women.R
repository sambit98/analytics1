...
women
head(women)
names(women) # to get variables
cor(women$height,women$weight) # correlation tells u the direction as well as the strenghth of variation
cov(women$height , women$weight) # covarience tells u the direction of relationship + or -
pairs(women)
...
coef(fit1)
#Y = -87 + 3.4 * X  # no extrapolations possible 
