...
omni2a
omni2b=read.csv(file.choose()) #if u dont know the location of file and u have to choose the location
omni2b
head(omni2b)
...
fit3 = lm(sales ~ price + promotion, data=omni[-c(11,14,15),]) # if u will remove outliers r squares will increase 
plot(fit3,4)
summary(fit3)
